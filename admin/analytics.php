...
<script>
      <?php
            ...
            $female=$ro2['count'];
            $male=$row['count'];
            $q3="SELECT count(*) as count FROM food_donations where location=\"chikkaballapur\"";
            $res3=mysqli_query($connection, $q3);
            $ro3=mysqli_fetch_assoc($res3);
            $chikkaballapur=$ro3['count'];
            $q4="SELECT count(*) as count FROM food_donations where location=\"bengaluru\"";
...
var xplace=["chikkaballapur","bengaluru","kadapa"];
var yplace=[<?php echo json_encode($chikkaballapur,JSON_HEX_TAG);?>,<?php echo json_encode($kadapa,JSON_HEX_TAG);?>,<?php echo json_encode($bengaluru,JSON_HEX_TAG);?>];
